...
-----------[[[[    ФУНКЦИИ    ]]]]-----------
    function main()
		...
		autoupdate("https://gist.githubusercontent.com/mgvq/cd4eb26c18e61d9ebd5703cfcacd1dfb/raw/ec1ee68857a0a9ae84f99398691dd74ab277d860/autoupdate", '{00FFFF}[RHelper]: ', "https://github.com/mgvq/RHelper.luac")
		check_account()
	...
	function check_account()
		...
		get_gist("https://gist.githubusercontent.com/mgvq/ef9e73826a5c8dbe4468083b97e9cb79/raw/8ca72516e8ed0068a5fdebce49d65539ff067560/RHelper")
	end
			...
			if doesFileExist(json) then
			  ...
			  if f then
				...
				if updateversion ~= thisScript().version then
				  ...
				  update = false
				  local netreb = string.format("{EE82EE}v"..thisScript().version.." RHelper'a{1E90FF} Обновление не требуется.")
